...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            ...
            message: 'Session ของคุณกำลังจะหมดอายุในอีก',
            logoutButton: 'ออกจากระบบ',
            keepAliveButton: 'อยู่ในระบบต่อไป',
        ...
        if (!opt.ignoreUserActivity) {
            ...
            $(document).on('keyup mouseup mousemove touchend touchmove scroll focus', function(e) {
            ...
            // Clear session timer
                ...
                // Set session timer
                    ...
                    timer = setTimeout(function() {
                        ...
                        localStorage.setItem('active','sleep');
                        if (typeof opt.onWarn !== 'function' && localStorage.getItem('active') =="sleep") {                        
        ...
        window.addEventListener('storage', function(e) {
            if(e.key=="active")
            {
               if(localStorage.getItem('active') =="active")
               {
                    ...
                    $('body').removeClass('modal-open');
                    $('div.modal-backdrop').remove();
                    localStorage.setItem('active','wait');
               }
               else if(localStorage.getItem('active') =="begin")
               {
                   startSessionTimer();
               }
               else if(localStorage.getItem('active') =="sleep")
               { 
                   $('#session-timeout-dialog').modal('show');
               }  
